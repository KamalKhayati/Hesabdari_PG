namespace SystemManagement.UsersSystem
{
    partial class FrmAccesslevelDafaterMali
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.treeListDafaterMali.OptionsSelection.MultiSelect = true;
            this.treeListDafaterMali.OptionsView.CheckBoxStyle = DevExpress.XtraTreeList.DefaultNodeCheckBoxStyle.Check;
            this.treeListDafaterMali.OptionsView.ShowAutoFilterRow = true;
            this.treeListDafaterMali.OptionsView.ShowHorzLines = false;
            ...
            this.colLevelName1.AppearanceHeader.Options.UseTextOptions = true;
            this.colLevelName1.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
            ...
            // 
            this.msAccessLevelDafaterMalisBindingSource.DataSource = typeof(DBHesabdari_PG.Models.Ms.SystemUsers.MsAccessLevelDafaterMali);
            // 
            // barEditItem1
            // 
            ...
            this.Text = "دسترسی کاربران به دفاتر و دوره های مالی ایجاد شده";
            this.Load += new System.EventHandler(this.FrmAccesslevelDafaterMali_Load);
