        ...
        protected override void Seed(MyContext context)
        {
            ...
            using (context = new MyContext())
            {
                try
                {
                    ...
                    {
                        context.MsMajmoes.Add(new MsMajmoe() { MsMajmoeId = 1, MajmoeCode = 10, MajmoeName = "مجموعه زنجیره ای آفاق", PermissiveUsers = "مدیر سیستم,کمال خیاطی,جمال خیاطی,جلال خیاطی", MajmoeIsActive = true, IsDefault = true });
                        ...
                        context.MsMajmoes.Add(new MsMajmoe() { MsMajmoeId = 2, MajmoeCode = 11, MajmoeName = "مجتمع نرم افزاری تلاشگران", PermissiveUsers = "مدیر سیستم,کمال خیاطی,جمال خیاطی,جلال خیاطی", MajmoeIsActive = true, IsDefault = false });
                    ...
                    {
                        context.MsVaheds.Add(new MsVahed() { MsVahedId = 1, VahedCode = 1001, VahedName = "کارگاه ساخت درب و پنجره یو پی وی سی", PermissiveUsers = "مدیر سیستم,کمال خیاطی,جمال خیاطی,جلال خیاطی", VahedIsActive = true, MsMajmoeId = 1, MajmoeName = "مجموعه زنجیره ای آفاق", IsDefault = true });
                        ...
                        context.MsVaheds.Add(new MsVahed() { MsVahedId = 2, VahedCode = 1002, VahedName = "کارگاه تولیدی ام دی اف", PermissiveUsers = "مدیر سیستم,کمال خیاطی,جمال خیاطی,جلال خیاطی", VahedIsActive = true, MsMajmoeId = 1, MajmoeName = "مجموعه زنجیره ای آفاق", IsDefault = false });
                    ...
                    {
                        context.MsShobes.Add(new MsShobe() { MsShobeId = 1, ShobeCode = 100101, ShobeName = "شعبه خیابان ساحلی(یوپی وی سی)", PermissiveUsers = "مدیر سیستم,کمال خیاطی,جمال خیاطی,جلال خیاطی", ShobeIsActive = true, MsMajmoeId = 1, MajmoeName = "مجموعه زنجیره ای آفاق", MsVahedId = 1, VahedName = "کارگاه ساخت درب و پنجره یو پی وی سی", IsDefault = true });
                        ...
                        context.MsShobes.Add(new MsShobe() { MsShobeId = 2, ShobeCode = 100102, ShobeName = "شعبه بازارچه(یوپی وی سی)", PermissiveUsers = "مدیر سیستم,کمال خیاطی,جمال خیاطی,جلال خیاطی", ShobeIsActive = true, MsMajmoeId = 1, MajmoeName = "مجموعه زنجیره ای آفاق", MsVahedId = 1, VahedName = "کارگاه ساخت درب و پنجره یو پی وی سی", IsDefault = false });
                        ...
                        ////////////////////////////////////////////////////////////////////////////////////////////
                        context.MsShobes.Add(new MsShobe() { MsShobeId = 3, ShobeCode = 100201, ShobeName = "شعبه خیابان ساحلی(ام دی اف)", PermissiveUsers = "مدیر سیستم,کمال خیاطی,جمال خیاطی,جلال خیاطی", ShobeIsActive = true, MsMajmoeId = 1, MajmoeName = "مجموعه زنجیره ای آفاق", MsVahedId = 2, VahedName = "کارگاه تولیدی ام دی اف", IsDefault = false });
                        ...
                        context.MsShobes.Add(new MsShobe() { MsShobeId = 4, ShobeCode = 100202, ShobeName = "شعبه ملاجامی(ام دی اف)", PermissiveUsers = "مدیر سیستم,کمال خیاطی,جمال خیاطی,جلال خیاطی", ShobeIsActive = true, MsMajmoeId = 1, MajmoeName = "مجموعه زنجیره ای آفاق", MsVahedId = 2, VahedName = "کارگاه تولیدی ام دی اف", IsDefault = false });
                    ...
                    context.Entry(new MsAccessLevel1() { AccessLevel1Id = 55350, ParentId = 55300, LevelName = "تغییر رمز ورود کاربران" }).State = context.MsAccessLevel1s.Any(s => s.AccessLevel1Id == 55350) ? EntityState.Modified : EntityState.Added;
