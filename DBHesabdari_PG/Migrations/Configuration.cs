            ...
            using (context = new MyContext())
            {
                try
                {
                    ...
                    if (!context.EpAllGroupTafsilis.Any())
                    {
                        ...
                        var q6 = new EpGroupTafsiliLevel1() { Id = 6, Code = 60, StartCode = 60000001, EndCode = 60999999, Name = "مواد", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehIndex = 1, TabaghehName = "اقلام انبار" };
                        context.Entry(new EpAllGroupTafsili() { Id = 6, KeyCode = 60, ParentCode = 60, LevelName = "مواد", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel1 = q6 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 60) ? EntityState.Unchanged : EntityState.Added;
                        var q7 = new EpGroupTafsiliLevel1() { Id = 7, Code = 65, StartCode = 65000001, EndCode = 65999999, Name = "قطعات و ملزومات", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehIndex = 1, TabaghehName = "اقلام انبار" };
                        context.Entry(new EpAllGroupTafsili() { Id = 7, KeyCode = 65, ParentCode = 65, LevelName = "قطعات و ملزومات", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel1 = q7 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 65) ? EntityState.Unchanged : EntityState.Added;
                        var q8 = new EpGroupTafsiliLevel1() { Id = 8, Code = 70, StartCode = 70000001, EndCode = 70999999, Name = "محصولات", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehIndex = 1, TabaghehName = "اقلام انبار" };
                        context.Entry(new EpAllGroupTafsili() { Id = 8, KeyCode = 70, ParentCode = 70, LevelName = "محصولات", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel1 = q8 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 70) ? EntityState.Unchanged : EntityState.Added;
                        var q9 = new EpGroupTafsiliLevel1() { Id = 9, Code = 75, StartCode = 75000001, EndCode = 75999999, Name = "کالاها", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehIndex = 1, TabaghehName = "اقلام انبار" };
                        context.Entry(new EpAllGroupTafsili() { Id = 9, KeyCode = 75, ParentCode = 75, LevelName = "کالاها", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel1 = q9 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 75) ? EntityState.Unchanged : EntityState.Added;
                        var q10 = new EpGroupTafsiliLevel1() { Id = 10, Code = 80, StartCode = 80000001, EndCode = 80999999, Name = "دارائیها", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehIndex = 2, TabaghehName = "دارائیها" };
                        context.Entry(new EpAllGroupTafsili() { Id = 10, KeyCode = 80, ParentCode = 80, LevelName = "دارائیها", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehGroupIndex = 2, TabaghehGroupName = "دارائیها", EpGroupTafsiliLevel1 = q10 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 80) ? EntityState.Unchanged : EntityState.Added;
                        var q11 = new EpGroupTafsiliLevel1() { Id = 11, Code = 85, StartCode = 85000001, EndCode = 85999999, Name = "صندوقها", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehIndex = 3, TabaghehName = "صندوقها" };
                        context.Entry(new EpAllGroupTafsili() { Id = 11, KeyCode = 85, ParentCode = 85, LevelName = "صندوقها", IsActive = true, SalId = 1, LevelNumber = 1, TabaghehGroupIndex = 3, TabaghehGroupName = "صندوقها", EpGroupTafsiliLevel1 = q11 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 85) ? EntityState.Unchanged : EntityState.Added;
                        ...
                        context.Entry(new EpAllGroupTafsili() { Id = 25, KeyCode = 601, ParentCode = 60, LevelName = "مواد", IsActive = true, SalId = 1 , LevelNumber = 2, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel2 = q25 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 601) ? EntityState.Unchanged : EntityState.Added;
                        ...
                        context.Entry(new EpAllGroupTafsili() { Id = 26, KeyCode = 651, ParentCode = 65, LevelName = "قطعات و ملزومات", IsActive = true, SalId = 1 , LevelNumber = 2, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel2 = q26 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 651) ? EntityState.Unchanged : EntityState.Added;
                        ...
                        context.Entry(new EpAllGroupTafsili() { Id = 27, KeyCode = 701, ParentCode = 70, LevelName = "محصولات", IsActive = true, SalId = 1 , LevelNumber = 2, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel2 = q27 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 701) ? EntityState.Unchanged : EntityState.Added;
                        ...
                        context.Entry(new EpAllGroupTafsili() { Id = 28, KeyCode = 751, ParentCode = 75, LevelName = "کالاها", IsActive = true, SalId = 1 , LevelNumber = 2, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel2 = q28 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 751) ? EntityState.Unchanged : EntityState.Added;
                        var q29 = new EpGroupTafsiliLevel2() { Id = 29, Code = 801, StartCode = 801000001, EndCode = 801999999, Name = "دارائیها", IsActive = true, SalId = 1 , LevelNumber = 2, Level1Id = 10 };
                        context.Entry(new EpAllGroupTafsili() { Id = 29, KeyCode = 801, ParentCode = 80, LevelName = "دارائیها", IsActive = true, SalId = 1 , LevelNumber = 2, TabaghehGroupIndex = 2, TabaghehGroupName = "دارائیها", EpGroupTafsiliLevel2 = q29 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 801) ? EntityState.Unchanged : EntityState.Added;
                        var q30 = new EpGroupTafsiliLevel2() { Id = 30, Code = 851, StartCode = 851000001, EndCode = 851999999, Name = "صندوقها", IsActive = true, SalId = 1 , LevelNumber = 2, Level1Id = 11 };
                        context.Entry(new EpAllGroupTafsili() { Id = 30, KeyCode = 851, ParentCode = 85, LevelName = "صندوقها", IsActive = true, SalId = 1 , LevelNumber = 2, TabaghehGroupIndex = 3, TabaghehGroupName = "صندوقها", EpGroupTafsiliLevel2 = q30 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 851) ? EntityState.Unchanged : EntityState.Added;
                        ...
                        context.Entry(new EpAllGroupTafsili() { Id = 44, KeyCode = 6011, ParentCode = 601, LevelName = "مواد", IsActive = true, SalId = 1 , LevelNumber = 3, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel3 = q44 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 6011) ? EntityState.Unchanged : EntityState.Added;
                        ...
                        context.Entry(new EpAllGroupTafsili() { Id = 45, KeyCode = 6511, ParentCode = 651, LevelName = "قطعات و ملزومات", IsActive = true, SalId = 1 , LevelNumber = 3, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel3 = q45 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 6511) ? EntityState.Unchanged : EntityState.Added;
                        ...
                        context.Entry(new EpAllGroupTafsili() { Id = 46, KeyCode = 7011, ParentCode = 701, LevelName = "محصولات", IsActive = true, SalId = 1 , LevelNumber = 3, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel3 = q46 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 7011) ? EntityState.Unchanged : EntityState.Added;
                        ...
                        context.Entry(new EpAllGroupTafsili() { Id = 47, KeyCode = 7511, ParentCode = 751, LevelName = "کالاها", IsActive = true, SalId = 1 , LevelNumber = 3, TabaghehGroupIndex = 1, TabaghehGroupName = "اقلام انبار", EpGroupTafsiliLevel3 = q47 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 7511) ? EntityState.Unchanged : EntityState.Added;
                        var q48 = new EpGroupTafsiliLevel3() { Id = 48, Code = 8011, StartCode = 8011000001, EndCode = 8011999999, Name = "دارائیها", IsActive = true, SalId = 1 , LevelNumber = 3, Level2Id = 29 };
                        context.Entry(new EpAllGroupTafsili() { Id = 48, KeyCode = 8011, ParentCode = 801, LevelName = "دارائیها", IsActive = true, SalId = 1 , LevelNumber = 3, TabaghehGroupIndex = 2, TabaghehGroupName = "دارائیها", EpGroupTafsiliLevel3 = q48 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 8011) ? EntityState.Unchanged : EntityState.Added;
                        var q49 = new EpGroupTafsiliLevel3() { Id = 49, Code = 8511, StartCode = 8511000001, EndCode = 8511999999, Name = "صندوقها", IsActive = true, SalId = 1 , LevelNumber = 3, Level2Id = 30 };
                        context.Entry(new EpAllGroupTafsili() { Id = 49, KeyCode = 8511, ParentCode = 851, LevelName = "صندوقها", IsActive = true, SalId = 1 , LevelNumber = 3, TabaghehGroupIndex = 3, TabaghehGroupName = "صندوقها", EpGroupTafsiliLevel3 = q49 }).State = context.EpAllGroupTafsilis.Any(s => s.KeyCode == 8511) ? EntityState.Unchanged : EntityState.Added;
                    ...
                    /////////////// تعریف کدینگ انبار و کالا
                    {
                        ...
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 701, ParentCode = 701, LevelNumber = 1, LevelName = "محصولات", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId1.Id, EpTabaghehKala1 = new EpTabaghehKala() { SalId = 1, LevelNumber = 1, Code = 701, Name = "محصولات", VahedKalaId = _VahedAsliKalaId1.Id, GroupTafsiliId = _GroupTafsiliId1_3.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 701) ? EntityState.Detached : EntityState.Added;

                        var _GroupTafsiliId1_4 = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNumber == 2 && s.KeyCode == 751);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 751, ParentCode = 751, LevelNumber = 1, LevelName = "کالاها", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId1.Id, EpTabaghehKala1 = new EpTabaghehKala() { SalId = 1, LevelNumber = 1, Code = 751, Name = "کالاها", VahedKalaId = _VahedAsliKalaId1.Id, GroupTafsiliId = _GroupTafsiliId1_4.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 751) ? EntityState.Detached : EntityState.Added;
                        context.SaveChanges();
