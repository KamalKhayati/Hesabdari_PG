            ...
            using (context = new MyContext())
            {
                try
                {
                    ...
                    //////////// تعریف کدینگ حسابداری
                    {
                        ...
                        //////////////// تعریف طبقه
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1, ParentCode = 1, LevelNamber = 1, LevelName = "دارائیها", IsActive = true, EpHesabTabagheh1 = new EpHesabTabagheh() { SalId = 1, Code = 1, Name = "دارائیها", IndexNoeHesab = 0, NoeHesab = "ترازنامه ای", IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2, ParentCode = 2, LevelNamber = 1, LevelName = "بدهیها", IsActive = true, EpHesabTabagheh1 = new EpHesabTabagheh() { SalId = 1, Code = 2, Name = "بدهیها", IndexNoeHesab = 0, NoeHesab = "ترازنامه ای", IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 3, ParentCode = 3, LevelNamber = 1, LevelName = "حقوق صاحبان سهام", IsActive = true, EpHesabTabagheh1 = new EpHesabTabagheh() { SalId = 1, Code = 3, Name = "حقوق صاحبان سهام", IndexNoeHesab = 0, NoeHesab = "ترازنامه ای", IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 3) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4, ParentCode = 4, LevelNamber = 1, LevelName = "عملکرد (سود و زیان)", IsActive = true, EpHesabTabagheh1 = new EpHesabTabagheh() { SalId = 1, Code = 4, Name = "عملکرد (سود و زیان)", IndexNoeHesab = 1, NoeHesab = "سود و زیانی", IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 5, ParentCode = 5, LevelNamber = 1, LevelName = "حسابهای انتظامی و کنترلی", IsActive = true, EpHesabTabagheh1 = new EpHesabTabagheh() { SalId = 1, Code = 5, Name = "حسابهای انتظامی و کنترلی", IndexNoeHesab = 0, NoeHesab = "انتظامی و کنترلی", IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 5) ? EntityState.Detached : EntityState.Added;
                        context.SaveChanges();
                        /////////////////// تعریف گروه
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 11, ParentCode = 1, LevelNamber = 2, LevelName = "دارائیهای جاری", IsActive = true, EpHesabGroup1 = new EpHesabGroup() { SalId = 1, Code = 11, Name = "دارائیهای جاری", TabaghehId = context.EpHesabTabaghehs.FirstOrDefault(s => s.SalId == 1 && s.Code == 1).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 11) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 12, ParentCode = 1, LevelNamber = 2, LevelName = "دارائیهای غیرجاری", IsActive = true, EpHesabGroup1 = new EpHesabGroup() { SalId = 1, Code = 12, Name = "دارائیهای غیرجاری", TabaghehId = context.EpHesabTabaghehs.FirstOrDefault(s => s.SalId == 1 && s.Code == 1).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 12) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 21, ParentCode = 2, LevelNamber = 2, LevelName = "بدهیهای جاری", IsActive = true, EpHesabGroup1 = new EpHesabGroup() { SalId = 1, Code = 21, Name = "بدهیهای جاری", TabaghehId = context.EpHesabTabaghehs.FirstOrDefault(s => s.SalId == 1 && s.Code == 2).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 21) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 22, ParentCode = 2, LevelNamber = 2, LevelName = "بدهیهای غیرجاری", IsActive = true, EpHesabGroup1 = new EpHesabGroup() { SalId = 1, Code = 22, Name = "بدهیهای غیرجاری", TabaghehId = context.EpHesabTabaghehs.FirstOrDefault(s => s.SalId == 1 && s.Code == 2).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 22) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 31, ParentCode = 3, LevelNamber = 2, LevelName = "حقوق صاحبان سهام", IsActive = true, EpHesabGroup1 = new EpHesabGroup() { SalId = 1, Code = 31, Name = "حقوق صاحبان سهام", TabaghehId = context.EpHesabTabaghehs.FirstOrDefault(s => s.SalId == 1 && s.Code == 3).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 31) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 41, ParentCode = 4, LevelNamber = 2, LevelName = "فروش و سایر درآمدها", IsActive = true, EpHesabGroup1 = new EpHesabGroup() { SalId = 1, Code = 41, Name = "فروش و سایر درآمدها", TabaghehId = context.EpHesabTabaghehs.FirstOrDefault(s => s.SalId == 1 && s.Code == 4).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 41) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 42, ParentCode = 4, LevelNamber = 2, LevelName = "بهای تمام شده کالای فروش رفته و خدمات ارائه شده", IsActive = true, EpHesabGroup1 = new EpHesabGroup() { SalId = 1, Code = 42, Name = "بهای تمام شده کالای فروش رفته و خدمات ارائه شده", TabaghehId = context.EpHesabTabaghehs.FirstOrDefault(s => s.SalId == 1 && s.Code == 4).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 42) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 43, ParentCode = 4, LevelNamber = 2, LevelName = "هزینه های فعالیت و سایر هزینه ها", IsActive = true, EpHesabGroup1 = new EpHesabGroup() { SalId = 1, Code = 43, Name = "هزینه های فعالیت و سایر هزینه ها", TabaghehId = context.EpHesabTabaghehs.FirstOrDefault(s => s.SalId == 1 && s.Code == 4).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 43) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 51, ParentCode = 5, LevelNamber = 2, LevelName = "حسابهای انتظامی و کنترلی", IsActive = true, EpHesabGroup1 = new EpHesabGroup() { SalId = 1, Code = 51, Name = "حسابهای انتظامی و کنترلی", TabaghehId = context.EpHesabTabaghehs.FirstOrDefault(s => s.SalId == 1 && s.Code == 5).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 51) ? EntityState.Detached : EntityState.Added;
                        context.SaveChanges();
                        /////////////////// تعریف کل
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1101, ParentCode = 11, LevelNamber = 3, LevelName = "موجودی نقد و بانک", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1101, Name = "موجودی نقد و بانک", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 11).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1101) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1102, ParentCode = 11, LevelNamber = 3, LevelName = "سرمایه گذاری کوتاه مدت", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1102, Name = "سرمایه گذاری کوتاه مدت", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 11).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1102) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1103, ParentCode = 11, LevelNamber = 3, LevelName = "حسابها و اسناد دریافتنی تجاری", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1103, Name = "حسابها و اسناد دریافتنی تجاری", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 11).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1103) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1104, ParentCode = 11, LevelNamber = 3, LevelName = "سایر حسابها و اسناد دریافتنی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1104, Name = "سایر حسابها و اسناد دریافتنی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 11).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1104) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1105, ParentCode = 11, LevelNamber = 3, LevelName = "موجودی مواد وکالا", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1105, Name = "موجودی مواد وکالا", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 11).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1105) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1106, ParentCode = 11, LevelNamber = 3, LevelName = "سفارشات و پیش پرداخت ها", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1106, Name = "سفارشات و پیش پرداخت ها", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 11).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1106) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1107, ParentCode = 11, LevelNamber = 3, LevelName = "سپردهای ما نزد دیگران", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1107, Name = "سپردهای ما نزد دیگران", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 11).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1107) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1201, ParentCode = 12, LevelNamber = 3, LevelName = "دارائیهای ثابت مشهود", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1201, Name = "دارائیهای ثابت مشهود", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 12).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1201) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1202, ParentCode = 12, LevelNamber = 3, LevelName = "استهلاک انباشته دارائیهای ثابت مشهود", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1202, Name = "استهلاک انباشته دارائیهای ثابت مشهود", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 12).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1202) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1203, ParentCode = 12, LevelNamber = 3, LevelName = "دارائیهای در جریان تکمیل", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1203, Name = "دارائیهای در جریان تکمیل", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 12).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1203) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1204, ParentCode = 12, LevelNamber = 3, LevelName = "دارائیهای نامشهود", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1204, Name = "دارائیهای نامشهود", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 12).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1204) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1205, ParentCode = 12, LevelNamber = 3, LevelName = "سرمایه گذاری بلند مدت", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1205, Name = "سرمایه گذاری بلند مدت", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 12).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1205) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1206, ParentCode = 12, LevelNamber = 3, LevelName = "سایر دارائیهای غیر جاری", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 1206, Name = "سایر دارائیهای غیر جاری", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 12).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 1206) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2101, ParentCode = 21, LevelNamber = 3, LevelName = "حسابها و اسناد پرداختنی تجاری", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2101, Name = "حسابها و اسناد پرداختنی تجاری", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 21).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2101) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2102, ParentCode = 21, LevelNamber = 3, LevelName = "سایر حسابهاو اسناد پرداختنی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2102, Name = "سایر حسابهاو اسناد پرداختنی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 21).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2102) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2103, ParentCode = 21, LevelNamber = 3, LevelName = "سفارشات و پیش دریافت ها", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2103, Name = "سفارشات و پیش دریافت ها", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 21).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2103) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2104, ParentCode = 21, LevelNamber = 3, LevelName = "ذخیره مالیات", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2104, Name = "ذخیره مالیات", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 21).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2104) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2105, ParentCode = 21, LevelNamber = 3, LevelName = "سود سهام پرداختنی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2105, Name = "سود سهام پرداختنی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 21).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2105) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2106, ParentCode = 21, LevelNamber = 3, LevelName = "سپرده های پرداختنی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2106, Name = "سپرده های پرداختنی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 21).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2106) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2107, ParentCode = 21, LevelNamber = 3, LevelName = "تسهیلات دریافتی کوتاه مدت", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2107, Name = "تسهیلات دریافتی کوتاه مدت", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 21).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2107) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2108, ParentCode = 21, LevelNamber = 3, LevelName = "ذخایر", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2108, Name = "ذخایر", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 21).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2108) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2201, ParentCode = 22, LevelNamber = 3, LevelName = "حسابها و اسناد پرداختنی بلندمدت تجاری", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2201, Name = "حسابها و اسناد پرداختنی بلندمدت تجاری", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 22).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2201) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2202, ParentCode = 22, LevelNamber = 3, LevelName = "سایر حسابها و اسناد پرداختنی بلندمدت", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2202, Name = "سایر حسابها و اسناد پرداختنی بلندمدت", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 22).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2202) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2203, ParentCode = 22, LevelNamber = 3, LevelName = "تسهیلات دریافتی بلندمدت", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2203, Name = "تسهیلات دریافتی بلندمدت", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 22).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2203) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2204, ParentCode = 22, LevelNamber = 3, LevelName = "ذخیره مزایای پایان خدمت کارکنان", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2204, Name = "ذخیره مزایای پایان خدمت کارکنان", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 22).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2204) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2205, ParentCode = 22, LevelNamber = 3, LevelName = "درآمدهای انتقالی به دوره های آتی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 2205, Name = "درآمدهای انتقالی به دوره های آتی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 22).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 2205) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 3101, ParentCode = 31, LevelNamber = 3, LevelName = "سرمایه پرداخت شده", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 3101, Name = "سرمایه پرداخت شده", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 31).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 3101) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 3102, ParentCode = 31, LevelNamber = 3, LevelName = "اندورخته قانونی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 3102, Name = "اندورخته قانونی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 31).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 3102) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 3103, ParentCode = 31, LevelNamber = 3, LevelName = "سایر اندوخته ها", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 3103, Name = "سایر اندوخته ها", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 31).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 3103) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 3104, ParentCode = 31, LevelNamber = 3, LevelName = "مازاد تجدید ارزیابی دارائیهای ثابت مشهود", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 3104, Name = "مازاد تجدید ارزیابی دارائیهای ثابت مشهود", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 31).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 3104) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 3105, ParentCode = 31, LevelNamber = 3, LevelName = "سود و زیان انباشته", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 3105, Name = "سود و زیان انباشته", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 31).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 3105) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4101, ParentCode = 41, LevelNamber = 3, LevelName = "فروش", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4101, Name = "فروش", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 41).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4101) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4102, ParentCode = 41, LevelNamber = 3, LevelName = "درآمد حاصل از ارائه خدمات", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4102, Name = "درآمد حاصل از ارائه خدمات", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 41).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4102) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4103, ParentCode = 41, LevelNamber = 3, LevelName = "سایر درآمدهای عملیاتی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4103, Name = "سایر درآمدهای عملیاتی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 41).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4103) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4104, ParentCode = 41, LevelNamber = 3, LevelName = "سایر درآمدهای غیر عملیاتی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4104, Name = "سایر درآمدهای غیر عملیاتی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 41).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4104) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4201, ParentCode = 42, LevelNamber = 3, LevelName = "بهای تمام شده کالای فروش رفته داخلی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4201, Name = "بهای تمام شده کالای فروش رفته داخلی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 42).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4201) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4202, ParentCode = 42, LevelNamber = 3, LevelName = "بهای تمام شده کالای فروش رفته خارجی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4202, Name = "بهای تمام شده کالای فروش رفته خارجی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 42).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4202) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4203, ParentCode = 42, LevelNamber = 3, LevelName = "بهای تمام شده خدمات ارائه شده", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4203, Name = "بهای تمام شده خدمات ارائه شده", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 42).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4203) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4301, ParentCode = 43, LevelNamber = 3, LevelName = "هزینه حقوق و دستمزد", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4301, Name = "هزینه حقوق و دستمزد", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 43).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4301) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4302, ParentCode = 43, LevelNamber = 3, LevelName = "هزینه های عملیاتی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4302, Name = "هزینه های عملیاتی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 43).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4302) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4303, ParentCode = 43, LevelNamber = 3, LevelName = "سایر هزینه های عملیاتی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4303, Name = "سایر هزینه های عملیاتی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 43).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4303) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4304, ParentCode = 43, LevelNamber = 3, LevelName = "هزینه های مالی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4304, Name = "هزینه های مالی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 43).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4304) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4305, ParentCode = 43, LevelNamber = 3, LevelName = "هزینه های غیرعملیاتی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 4305, Name = "هزینه های غیرعملیاتی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 43).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 4305) ? EntityState.Detached : EntityState.Added;

                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 5101, ParentCode = 51, LevelNamber = 3, LevelName = "حسابهای انتظامی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 5101, Name = "حسابهای انتظامی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 51).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 5101) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 5102, ParentCode = 51, LevelNamber = 3, LevelName = "طرف حسابهای انتظامی", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 5102, Name = "طرف حسابهای انتظامی", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 51).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 5102) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 5103, ParentCode = 51, LevelNamber = 3, LevelName = "تراز افتتاحیه", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 5103, Name = "تراز افتتاحیه", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 51).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 5103) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 5104, ParentCode = 51, LevelNamber = 3, LevelName = "تراز اختتامیه", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 5104, Name = "تراز اختتامیه", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 51).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 5104) ? EntityState.Detached : EntityState.Added;
                        context.SaveChanges();
                        /////////////////// تعریف معین
                        ...
                        //List1.Add(new R_EpHesabMoin1_B_EpAllGroupTafsili() { SalId = 1, LevelNamber = 1, AllGroupTafsiliId = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 1 && s.TabaghehGroupName == "صندوقها").Id  });
                        ...
                        //context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 110101, ParentCode = 1101, LevelNamber = 4, LevelName = "صندوق ریالی", IsActive = true, R_EpAllCodingHesabdari_B_MsActiveSystems=List2,EpHesabMoin1 = new EpHesabMoin1() { SalId = 1, Code = 110101, Name = "صندوق ریالی", ColId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 1101).Id, IsActive = true, GroupTafsiliLevelsIndex = 1, GroupTafsiliLevelsName = "سطح 1", IndexMahiatHesab = 0, MahiatHesab = "مهم نیست", LevelNamber = 4, SelectedActivesystem = "فروش و خرید,دریافت وپرداخت,انبار وکالا,", SelectedGroupTafsiliLevels = "صندوق", R_EpHesabMoin1_B_EpAllGroupTafsilis= List1, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 110101) ? EntityState.Detached : EntityState.Added;

                        //context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 110101, ParentCode = 1101, LevelNamber = 4, LevelName = "", IsActive = true, EpHesabCol1 = new EpHesabCol() { SalId = 1, Code = 110101, Name = "", GroupId = context.EpHesabGroups.FirstOrDefault(s => s.SalId == 1 && s.Code == 1101).Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingHesabdaris.Any(s => s.SalId == 1 && s.KeyCode == 110101) ? EntityState.Detached : EntityState.Added;
                    ...
                    //////////// تعریف حسابهای تفصیلی
                    {
                        ...
                        long _Code1 = 30;
                        var _GroupAshkhas = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 1 && s.KeyCode == _Code1);
                        EpHesabTafsiliAshkhas Obj_Ashkhas1 = new EpHesabTafsiliAshkhas() { SalId = 1, Code = _Code1 * 1000000 + 1, Name = "کمال خیاطی", LevelNamber = 1, IsActive = true, GroupTafsiliId = _GroupAshkhas.Id, IsHaghighi = true, TarikhEjad = _datetime, SharhHesab = null, IsFroshandeh = false, IsHoghoghi = false, IsKharidar = true, IsPersonel = false, IsRanande = false, IsSahamdar = false, IsVizitor = false };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code1 * 1000000 + 1, LevelNamber = 1, Name = "کمال خیاطی", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupAshkhas.Id, EpHesabTafsiliAshkhas1 = Obj_Ashkhas1 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code1 * 1000000 + 1) ? EntityState.Detached : EntityState.Added;

                        EpHesabTafsiliAshkhas Obj_Ashkhas2 = new EpHesabTafsiliAshkhas() { SalId = 1, Code = _Code1 * 1000000 + 2, Name = "جمال خیاطی", LevelNamber = 1, IsActive = true, GroupTafsiliId = _GroupAshkhas.Id, IsHaghighi = true, TarikhEjad = _datetime, SharhHesab = null, IsFroshandeh = false, IsHoghoghi = false, IsKharidar = true, IsPersonel = false, IsRanande = false, IsSahamdar = false, IsVizitor = false };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code1 * 1000000 + 2, LevelNamber = 1, Name = "جمال خیاطی", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupAshkhas.Id, EpHesabTafsiliAshkhas1 = Obj_Ashkhas2 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code1 * 1000000 + 2) ? EntityState.Detached : EntityState.Added;

                        EpHesabTafsiliAshkhas Obj_Ashkhas3 = new EpHesabTafsiliAshkhas() { SalId = 1, Code = _Code1 * 1000000 + 3, Name = "جلال خیاطی", LevelNamber = 1, IsActive = true, GroupTafsiliId = _GroupAshkhas.Id, IsHaghighi = true, TarikhEjad = _datetime, SharhHesab = null, IsFroshandeh = false, IsHoghoghi = false, IsKharidar = true, IsPersonel = false, IsRanande = false, IsSahamdar = false, IsVizitor = false };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code1 * 1000000 + 3, LevelNamber = 1, Name = "جلال خیاطی", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupAshkhas.Id, EpHesabTafsiliAshkhas1 = Obj_Ashkhas3 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code1 * 1000000 + 3) ? EntityState.Detached : EntityState.Added;

                        EpHesabTafsiliAshkhas Obj_Ashkhas4 = new EpHesabTafsiliAshkhas() { SalId = 1, Code = _Code1 * 1000000 + 4, Name = "کاوه خیاطی", LevelNamber = 1, IsActive = true, GroupTafsiliId = _GroupAshkhas.Id, IsHaghighi = true, TarikhEjad = _datetime, SharhHesab = null, IsFroshandeh = false, IsHoghoghi = false, IsKharidar = true, IsPersonel = false, IsRanande = false, IsSahamdar = false, IsVizitor = false };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code1 * 1000000 + 4, LevelNamber = 1, Name = "کاوه خیاطی", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupAshkhas.Id, EpHesabTafsiliAshkhas1 = Obj_Ashkhas4 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code1 * 1000000 + 4) ? EntityState.Detached : EntityState.Added;

                        ///////////// تعریف صندوق
                        long _Code2 = 85;
                        var _GroupSandogh = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 1 && s.KeyCode == _Code2);
                        EpHesabTafsiliSandogh Obj_Sandogh1 = new EpHesabTafsiliSandogh() { SalId = 1, Code = _Code2 * 1000000 + 1, Name = "صندوق اصلی", LevelNamber = 1, IsActive = true, GroupTafsiliId = _GroupSandogh.Id, TarikhEjad = _datetime, IsDefault = true, NameMasol = null, SharhHesab = null };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code2 * 1000000 + 1, LevelNamber = 1, Name = "صندوق اصلی", IsActive = true, IsDefault = true, SharhHesab = null, GroupTafsiliId = _GroupSandogh.Id, EpHesabTafsiliSandogh1 = Obj_Sandogh1 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code2 * 1000000 + 1) ? EntityState.Detached : EntityState.Added;

                        EpHesabTafsiliSandogh Obj_Sandogh2 = new EpHesabTafsiliSandogh() { SalId = 1, Code = _Code2 * 1000000 + 2, Name = "صندوق فرعی", LevelNamber = 1, IsActive = true, GroupTafsiliId = _GroupSandogh.Id, TarikhEjad = _datetime, IsDefault = false, NameMasol = null, SharhHesab = null };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code2 * 1000000 + 2, LevelNamber = 1, Name = "صندوق فرعی", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupSandogh.Id, EpHesabTafsiliSandogh1 = Obj_Sandogh2 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code2 * 1000000 + 2) ? EntityState.Detached : EntityState.Added;

                        ///////////// تعریف انبار
                        long _Code3 = 94;
                        var _GroupAnbar = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 1 && s.KeyCode == _Code3);
                        EpHesabTafsiliAnbarha Obj_Anbar1 = new EpHesabTafsiliAnbarha() { SalId = 1, Code = _Code3 * 1000000 + 1, Name = "انبار اصلی", LevelNamber = 1, IsActive = true, GroupTafsiliId = _GroupAnbar.Id, TarikhEjad = _datetime, SharhHesab = null };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code3 * 1000000 + 1, LevelNamber = 1, Name = "انبار اصلی", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupAnbar.Id, EpHesabTafsiliAnbarha1 = Obj_Anbar1 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code3 * 1000000 + 1) ? EntityState.Detached : EntityState.Added;

                        EpHesabTafsiliAnbarha Obj_Anbar2 = new EpHesabTafsiliAnbarha() { SalId = 1, Code = _Code3 * 1000000 + 2, Name = "انبار فرعی", LevelNamber = 1, IsActive = true, GroupTafsiliId = _GroupAnbar.Id, TarikhEjad = _datetime, SharhHesab = null };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code3 * 1000000 + 2, LevelNamber = 1, Name = "انبار فرعی", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupAnbar.Id, EpHesabTafsiliAnbarha1 = Obj_Anbar2 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code3 * 1000000 + 2) ? EntityState.Detached : EntityState.Added;
                        //context.SaveChanges();

                        ///////////// تعریف سایر 
                        long _Code4 = 95;
                        var _GroupSayer1 = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 1 && s.KeyCode == _Code4);
                        EpHesabTafsiliSayer Obj_Sayer1 = new EpHesabTafsiliSayer() { SalId = 1, Code = _Code4 * 1000000 + 1, Name = "سایر 1", LevelNamber = 1, IsActive = true, GroupTafsiliId = _GroupSayer1.Id, TarikhEjad = _datetime, SharhHesab = null };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code4 * 1000000 + 1, LevelNamber = 1, Name = "سایر 1", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupSayer1.Id, EpHesabTafsiliSayer1 = Obj_Sayer1 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code4 * 1000000 + 1) ? EntityState.Detached : EntityState.Added;

                        long _Code5 = 951;
                        var _GroupSayer2 = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == _Code5);
                        EpHesabTafsiliSayer Obj_Sayer2 = new EpHesabTafsiliSayer() { SalId = 1, Code = _Code5 * 1000000 + 1, Name = "سایر 2", LevelNamber = 2, IsActive = true, GroupTafsiliId = _GroupSayer2.Id, TarikhEjad = _datetime, SharhHesab = null };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code5 * 1000000 + 1, LevelNamber = 2, Name = "سایر 2", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupSayer2.Id, EpHesabTafsiliSayer1 = Obj_Sayer2 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code5 * 1000000 + 1) ? EntityState.Detached : EntityState.Added;

                        long _Code6 = 9511;
                        var _GroupSayer3 = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 3 && s.KeyCode == _Code6);
                        EpHesabTafsiliSayer Obj_Sayer3 = new EpHesabTafsiliSayer() { SalId = 1, Code = _Code6 * 1000000 + 1, Name = "سایر 3", LevelNamber = 3, IsActive = true, GroupTafsiliId = _GroupSayer3.Id, TarikhEjad = _datetime, SharhHesab = null };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code6 * 1000000 + 1, LevelNamber = 3, Name = "سایر 3", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupSayer3.Id, EpHesabTafsiliSayer1 = Obj_Sayer3 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code6 * 1000000 + 1) ? EntityState.Detached : EntityState.Added;

                        ///////////// تعریف شعبات 
                        long _Code7 = 9111;
                        var _GroupShoabat = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 3 && s.KeyCode == _Code7);
                        EpHesabTafsiliShoabat Obj_Shoabat1 = new EpHesabTafsiliShoabat() { SalId = 1, Code = _Code7 * 1000000 + 1, Name = "شعبه 1", LevelNamber = 3, IsActive = true, GroupTafsiliId = _GroupShoabat.Id, TarikhEjad = _datetime, SharhHesab = null };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code7 * 1000000 + 1, LevelNamber = 3, Name = "شعبه 1", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupShoabat.Id, EpHesabTafsiliShoabat1 = Obj_Shoabat1 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code7 * 1000000 + 1) ? EntityState.Detached : EntityState.Added;

                        EpHesabTafsiliShoabat Obj_Shoabat2 = new EpHesabTafsiliShoabat() { SalId = 1, Code = _Code7 * 1000000 + 2, Name = "شعبه 2", LevelNamber = 3, IsActive = true, GroupTafsiliId = _GroupShoabat.Id, TarikhEjad = _datetime, SharhHesab = null };
                        context.Entry(new EpAllHesabTafsili() { SalId = 1, Code = _Code7 * 1000000 + 2, LevelNamber = 3, Name = "شعبه 2", IsActive = true, SharhHesab = null, GroupTafsiliId = _GroupShoabat.Id, EpHesabTafsiliShoabat1 = Obj_Shoabat2 }).State = context.EpAllHesabTafsilis.Any(s => s.SalId == 1 && s.Code == _Code7 * 1000000 + 2) ? EntityState.Detached : EntityState.Added;
                    ...
                    /////////////// تعریف کدینگ انبار و کالا
                    {
                        ...
                        var _GroupTafsiliId1_1 = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 601);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601, ParentCode = 601, LevelNamber = 1, LevelName = "مواد", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId1.Id, EpTabaghehKala1 = new EpTabaghehKala() { SalId = 1, Code = 601, Name = "مواد", VahedKalaId = _VahedAsliKalaId1.Id, GroupTafsiliId = _GroupTafsiliId1_1.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601) ? EntityState.Detached : EntityState.Added;

                        var _GroupTafsiliId1_2 = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 651);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651, ParentCode = 651, LevelNamber = 1, LevelName = "قطعات و ملزومات", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId1.Id, EpTabaghehKala1 = new EpTabaghehKala() { SalId = 1, Code = 651, Name = "قطعات و ملزومات", VahedKalaId = _VahedAsliKalaId1.Id, GroupTafsiliId = _GroupTafsiliId1_2.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651) ? EntityState.Detached : EntityState.Added;

                        var _GroupTafsiliId1_3 = context.EpAllGroupTafsilis.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 701);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 701, ParentCode = 701, LevelNamber = 1, LevelName = "محصولات", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId1.Id, EpTabaghehKala1 = new EpTabaghehKala() { SalId = 1, Code = 701, Name = "محصولات", VahedKalaId = _VahedAsliKalaId1.Id, GroupTafsiliId = _GroupTafsiliId1_3.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 701) ? EntityState.Detached : EntityState.Added;
                        ...
                        var _TabagheKalaId2_1 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 1 && s.KeyCode == 601);

                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601001, ParentCode = 601, LevelNamber = 2, LevelName = "فریم", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupAsliKala1 = new EpGroupAsliKala() { SalId = 1, Code = 601001, Name = "فریم", VahedKalaId = _VahedAsliKalaId2_1.Id, TabaghehId = _TabagheKalaId2_1.Id, IsActive = true, SharhHesab = null, } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601002, ParentCode = 601, LevelNamber = 2, LevelName = "ساش پنجره", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupAsliKala1 = new EpGroupAsliKala() { SalId = 1, Code = 601002, Name = "ساش پنجره", VahedKalaId = _VahedAsliKalaId2_1.Id, TabaghehId = _TabagheKalaId2_1.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601002) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601003, ParentCode = 601, LevelNamber = 2, LevelName = "مولیون", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupAsliKala1 = new EpGroupAsliKala() { SalId = 1, Code = 601003, Name = "مولیون", VahedKalaId = _VahedAsliKalaId2_1.Id, TabaghehId = _TabagheKalaId2_1.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601003) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601004, ParentCode = 601, LevelNamber = 2, LevelName = "ساش درب", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupAsliKala1 = new EpGroupAsliKala() { SalId = 1, Code = 601004, Name = "ساش درب", VahedKalaId = _VahedAsliKalaId2_1.Id, TabaghehId = _TabagheKalaId2_1.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601004) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601005, ParentCode = 601, LevelNamber = 2, LevelName = "پنل", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupAsliKala1 = new EpGroupAsliKala() { SalId = 1, Code = 601005, Name = "پنل", VahedKalaId = _VahedAsliKalaId2_1.Id, TabaghehId = _TabagheKalaId2_1.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601005) ? EntityState.Detached : EntityState.Added;

                        var _VahedAsliKalaId2_2 = context.EpVahedKalas.FirstOrDefault(s => s.SalId == 1 && s.Name == "عدد");
                        var _TabagheKalaId2_2 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 1 && s.KeyCode == 651);

                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651001, ParentCode = 651, LevelNamber = 2, LevelName = "دستگیره", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupAsliKala1 = new EpGroupAsliKala() { SalId = 1, Code = 651001, Name = "دستگیره", VahedKalaId = _VahedAsliKalaId2_2.Id, TabaghehId = _TabagheKalaId2_2.Id, IsActive = true, SharhHesab = null, } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651002, ParentCode = 651, LevelNamber = 2, LevelName = "قفل", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupAsliKala1 = new EpGroupAsliKala() { SalId = 1, Code = 651002, Name = "قفل", VahedKalaId = _VahedAsliKalaId2_2.Id, TabaghehId = _TabagheKalaId2_2.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651002) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651003, ParentCode = 651, LevelNamber = 2, LevelName = "اسپانیولیت", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupAsliKala1 = new EpGroupAsliKala() { SalId = 1, Code = 651003, Name = "اسپانیولیت", VahedKalaId = _VahedAsliKalaId2_2.Id, TabaghehId = _TabagheKalaId2_2.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651003) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651004, ParentCode = 651, LevelNamber = 2, LevelName = "لولا", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupAsliKala1 = new EpGroupAsliKala() { SalId = 1, Code = 651004, Name = "لولا", VahedKalaId = _VahedAsliKalaId2_2.Id, TabaghehId = _TabagheKalaId2_2.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651004) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651005, ParentCode = 651, LevelNamber = 2, LevelName = "مغزی", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupAsliKala1 = new EpGroupAsliKala() { SalId = 1, Code = 651005, Name = "مغزی", VahedKalaId = _VahedAsliKalaId2_2.Id, TabaghehId = _TabagheKalaId2_2.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651005) ? EntityState.Detached : EntityState.Added;
                        context.SaveChanges();

                        ////////////////  تعریف گروه فرعی اقلام انبار
                        var _GroupAsliKalaId3_1 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 601001);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601001001, ParentCode = 601001, LevelNamber = 3, LevelName = "فریم وین تک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 601001001, Name = "فریم وین تک", VahedKalaId = _VahedAsliKalaId2_1.Id, GroupAsliId = _GroupAsliKalaId3_1.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601001001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601001002, ParentCode = 601001, LevelNamber = 3, LevelName = "فریم آریاوین", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 601001002, Name = "فریم آریاوین", VahedKalaId = _VahedAsliKalaId2_1.Id, GroupAsliId = _GroupAsliKalaId3_1.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601001002) ? EntityState.Detached : EntityState.Added;

                        var _GroupAsliKalaId3_2 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 601002);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601002001, ParentCode = 601002, LevelNamber = 3, LevelName = "ساش پنجره وین تک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 601002001, Name = "ساش پنجره وین تک", VahedKalaId = _VahedAsliKalaId2_1.Id, GroupAsliId = _GroupAsliKalaId3_2.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601002001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601002002, ParentCode = 601002, LevelNamber = 3, LevelName = "ساش پنجره آریاوین", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 601002002, Name = "ساش پنجره آریاوین", VahedKalaId = _VahedAsliKalaId2_1.Id, GroupAsliId = _GroupAsliKalaId3_2.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601002002) ? EntityState.Detached : EntityState.Added;

                        var _GroupAsliKalaId3_3 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 601003);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601003001, ParentCode = 601003, LevelNamber = 3, LevelName = "مولیون وین تک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 601003001, Name = "مولیون وین تک", VahedKalaId = _VahedAsliKalaId2_1.Id, GroupAsliId = _GroupAsliKalaId3_3.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601003001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601003002, ParentCode = 601003, LevelNamber = 3, LevelName = "مولیون آریاوین", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 601003002, Name = "مولیون آریاوین", VahedKalaId = _VahedAsliKalaId2_1.Id, GroupAsliId = _GroupAsliKalaId3_3.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601003002) ? EntityState.Detached : EntityState.Added;

                        var _GroupAsliKalaId3_4 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 601004);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601004001, ParentCode = 601004, LevelNamber = 3, LevelName = "ساش درب وین تک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 601004001, Name = "ساش درب وین تک", VahedKalaId = _VahedAsliKalaId2_1.Id, GroupAsliId = _GroupAsliKalaId3_4.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601004001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601004002, ParentCode = 601004, LevelNamber = 3, LevelName = "ساش درب آریاوین", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 601004001, Name = "ساش درب آریاوین", VahedKalaId = _VahedAsliKalaId2_1.Id, GroupAsliId = _GroupAsliKalaId3_4.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601004002) ? EntityState.Detached : EntityState.Added;

                        var _GroupAsliKalaId3_5 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 601005);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601005001, ParentCode = 601005, LevelNamber = 3, LevelName = "پنل وین تک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 601005001, Name = "پنل وین تک", VahedKalaId = _VahedAsliKalaId2_1.Id, GroupAsliId = _GroupAsliKalaId3_5.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601005001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 601005002, ParentCode = 601005, LevelNamber = 3, LevelName = "پنل آریاوین", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_1.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 601005001, Name = "پنل آریاوین", VahedKalaId = _VahedAsliKalaId2_1.Id, GroupAsliId = _GroupAsliKalaId3_5.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 601005002) ? EntityState.Detached : EntityState.Added;
                        ///////////////
                        var _GroupAsliKalaId3_6 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 651001);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651001001, ParentCode = 651001, LevelNamber = 3, LevelName = "دستگیره ویناک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 651001001, Name = "دستگیره ویناک", VahedKalaId = _VahedAsliKalaId2_2.Id, GroupAsliId = _GroupAsliKalaId3_6.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651001001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651001002, ParentCode = 651001, LevelNamber = 3, LevelName = "دستگیره وین تک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 651001002, Name = "دستگیره وین تک", VahedKalaId = _VahedAsliKalaId2_2.Id, GroupAsliId = _GroupAsliKalaId3_6.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651001002) ? EntityState.Detached : EntityState.Added;

                        var _GroupAsliKalaId3_7 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 651002);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651002001, ParentCode = 651002, LevelNamber = 3, LevelName = "قفل ویناک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 651002001, Name = "قفل ویناک", VahedKalaId = _VahedAsliKalaId2_2.Id, GroupAsliId = _GroupAsliKalaId3_7.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651002001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651002002, ParentCode = 651002, LevelNamber = 3, LevelName = "قفل وین تک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 651002002, Name = "قفل وین تک", VahedKalaId = _VahedAsliKalaId2_2.Id, GroupAsliId = _GroupAsliKalaId3_7.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651002002) ? EntityState.Detached : EntityState.Added;

                        var _GroupAsliKalaId3_8 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 651003);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651003001, ParentCode = 651003, LevelNamber = 3, LevelName = "اسپانیولیت ویناک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 651003001, Name = "اسپانیولیت ویناک", VahedKalaId = _VahedAsliKalaId2_2.Id, GroupAsliId = _GroupAsliKalaId3_8.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651003001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651003002, ParentCode = 651003, LevelNamber = 3, LevelName = "اسپانیولیت وین تک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 651003001, Name = "اسپانیولیت وین تک", VahedKalaId = _VahedAsliKalaId2_2.Id, GroupAsliId = _GroupAsliKalaId3_8.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651003002) ? EntityState.Detached : EntityState.Added;

                        var _GroupAsliKalaId3_9 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 651004);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651004001, ParentCode = 651004, LevelNamber = 3, LevelName = "لولا ویناک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 651004001, Name = "لولا ویناک", VahedKalaId = _VahedAsliKalaId2_2.Id, GroupAsliId = _GroupAsliKalaId3_9.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651004001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651004002, ParentCode = 651004, LevelNamber = 3, LevelName = "لولا وین تک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 651004002, Name = "لولا وین تک", VahedKalaId = _VahedAsliKalaId2_2.Id, GroupAsliId = _GroupAsliKalaId3_9.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651004002) ? EntityState.Detached : EntityState.Added;

                        var _GroupAsliKalaId3_10 = context.EpAllCodingKalas.FirstOrDefault(s => s.SalId == 1 && s.LevelNamber == 2 && s.KeyCode == 651005);
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651005001, ParentCode = 651005, LevelNamber = 3, LevelName = "پنل ویناک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 651005001, Name = "پنل ویناک", VahedKalaId = _VahedAsliKalaId2_2.Id, GroupAsliId = _GroupAsliKalaId3_10.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651005001) ? EntityState.Detached : EntityState.Added;
                        context.Entry(new EpAllCodingKala() { SalId = 1, KeyCode = 651005002, ParentCode = 651005, LevelNamber = 3, LevelName = "پنل وین تک", IsActive = true, VahedAsliKalaId = _VahedAsliKalaId2_2.Id, EpGroupFareeKala1 = new EpGroupFareeKala() { SalId = 1, Code = 651005002, Name = "پنل وین تک", VahedKalaId = _VahedAsliKalaId2_2.Id, GroupAsliId = _GroupAsliKalaId3_10.Id, IsActive = true, SharhHesab = null } }).State = context.EpAllCodingKalas.Any(s => s.SalId == 1 && s.KeyCode == 651005002) ? EntityState.Detached : EntityState.Added;
