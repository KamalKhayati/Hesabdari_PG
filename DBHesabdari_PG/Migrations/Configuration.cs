        ...
        protected override void Seed(MyContext context)
        {
            ...
            using (context = new MyContext())
            {
                try
                {
                    ...
                    //if (!context.EpAllCodingHesabdaris.Any())
                    //{

                    //    List<EpHesabMoin1> List = new List<EpHesabMoin1>();
                    //    List.Add(new EpHesabMoin1() { SalId = 1, Code = 110101, Name = "صندوق",, IsActive = true, SharhHesab = "" });
                    //    context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 1, ParentCode = 1, LevelNamber = 1, LevelName = "دارائیها", IsActive = true, EpHesabTabagheh1 = new EpHesabTabagheh() { SalId = 1, Code = 1, Name = "دارائیها", IndexNoeHesab = 0, NoeHesab = "ترازنامه ای", IsActive = true, SharhHesab = "" } }).State = EntityState.Added;
                    //    context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 2, ParentCode = 2, LevelNamber = 1, LevelName = "بدهیها", IsActive = true, EpHesabTabagheh1 = new EpHesabTabagheh() { SalId = 1, Code = 2, Name = "بدهیها", IndexNoeHesab = 0, NoeHesab = "ترازنامه ای", IsActive = true, SharhHesab = "" } }).State = EntityState.Added;
                    //    context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 3, ParentCode = 3, LevelNamber = 1, LevelName = "حقوق صاحبان سهام", IsActive = true, EpHesabTabagheh1 = new EpHesabTabagheh() { SalId = 1, Code = 3, Name = "حقوق صاحبان سهام", IndexNoeHesab = 0, NoeHesab = "ترازنامه ای", IsActive = true, SharhHesab = "" } }).State = EntityState.Added;
                    //    context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 4, ParentCode = 4, LevelNamber = 1, LevelName = "عملکرد (سود و زیان)", IsActive = true, EpHesabTabagheh1 = new EpHesabTabagheh() { SalId = 1, Code = 4, Name = "عملکرد (سود و زیان)", IndexNoeHesab = 0, NoeHesab = "ترازنامه ای", IsActive = true, SharhHesab = "" } }).State = EntityState.Added;
                    //    context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 5, ParentCode = 5, LevelNamber = 1, LevelName = "حسابهای انتظامی و کنترلی", IsActive = true, EpHesabTabagheh1 = new EpHesabTabagheh() { SalId = 1, Code = 5, Name = "حسابهای انتظامی و کنترلی)", IndexNoeHesab = 0, NoeHesab = "ترازنامه ای", IsActive = true, SharhHesab = "" } }).State = EntityState.Added;

                    //    context.Entry(new EpAllCodingHesabdari() { SalId = 1, KeyCode = 11, ParentCode = 1, LevelNamber = 2, LevelName = "دارائیهای جاری", IsActive = true, EpHesabGroup1 = new EpHesabGroup() { SalId = 1, Code = 11, Name = "دارائیهای جاری", TabaghehId = context.EpHesabTabaghehs.FirstOrDefault(s => s.SalId == 1 && s.Code == 1).Id, IsActive = true, SharhHesab = "" } }).State = EntityState.Added;
